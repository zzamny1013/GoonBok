...
//loadItem 함수와 componentDidMount 함수 적당히 추가해주면됌.
  loadItem = async () => {
    axios
      .get("https://ad2be1ae-6f0d-4156-a378-99c5ad17baf5-3000.app.online.visualstudio.com/api/benefit2")
      .then(({ api }) => {
        this.setState({ 
          //loading: true,
          data: api
            ...
            renderRow={(item) => (
              <ListItem>
                ...
                //이미지 경로 바꿔줍시다. banner에는 "/img/a.png" 이런 식으로 저장되어 있습니다.
                  source={"https://ad2be1ae-6f0d-4156-a378-99c5ad17baf5-3000.app.online.visualstudio.com"+this.state.data[item].banner}
                  style={{
                    flex: 1,
                    resizeMode: 'stretch',
                    aspectRatio: 4 / 1,
